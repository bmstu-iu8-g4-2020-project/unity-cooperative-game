...
namespace UnityEngine.AI
{
    ...
    {
        [FormerlySerializedAs("m_AgentTypeID")]
        [SerializeField]
        int mAgentTypeID;
        public int AgentTypeID { get { return mAgentTypeID; } set { mAgentTypeID = value; } }

        [FormerlySerializedAs("m_CollectObjects")]
        [SerializeField]
        ...
        [FormerlySerializedAs("m_UseGeometry")]
        [SerializeField]
        ...
        [FormerlySerializedAs("m_OverrideTileSize")]
        [SerializeField]
