...
namespace UnityEngine.AI
{
    ...
    public class NavMeshLink : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("m_StartPoint")]
        [SerializeField]
        ...
        [FormerlySerializedAs("m_EndPoint")]
        [SerializeField]
